...
static int
initialize_clients (struct client *client)
{
    int	i;
...
static int
register_client (struct client *client, int num, const char *name)
{
    int	i;
    char    tmpbuf[30];
...
static int
cleanup_client (struct client *client, int num, fd_set *keep)
{
    int	i;
    char    tmpbuf[30];
...
static int
accept_client (struct client *client, int wait_sock, fd_set *keep)
{
    int	    i;
...
static int
handle_client (struct client *client, int cur)
{
    int	    i;
    ssize_t len;
